		...
		<div class="footer-opacity-img"></div>			
			...
			<div class="row">
				...
				<div class="bookmarks col-sm-6 pull-right">
					<span><?php _e('Theme by','linia'); ?><a href="http://burak-aydin.com" target="_blank"> Burak Aydin</a></span>
					 	<span>-</span>
					<span><?php _e('Powered by','linia'); ?><a href="http://wordpress.org" target="_blank"> WordPress</a></span>
				</div> <!-- end bookmarks -->
